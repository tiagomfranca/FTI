...
public class FuncionarioDAO {
	...
	public void cadastrarFuncionario(Funcionário funcionario) {
	...
	private void registrarFilhos(Funcionário funcionario) {
		Connection conn = null;
		PreparedStatement stmt = null;
		ResultSet rs = null;
	...
	public ArrayList<Funcionário> consultarListaFuncinoario() {

		ArrayList<Funcionário> listaFunc = new ArrayList<Funcionário>();
		...
		try {
			...
			while (rs.next()) {
				//fazer dois laços, um laço exterior para funcionário, um interior para filhos, comparando cod de cadastro sempre
				
				/*
				Funcionário funcionario = new Funcionário();
				
				if ( funcionario.getCodCadastro().equalsIgnoreCase(String.valueOf(rs.getInt("codigo"))) ) {
					funcionario.setCodCadastro(String.valueOf(rs.getInt("codigo")));
				...
				if (rs.getString(7).equals("Professor")){func = new Professor();} else {func = new Funcionário();}
				...
				func.setSexo(sexo);
				func.setDataNascimento(new Date(rs.getTimestamp("datanascimento").getTime()));
	...
	public void alterarFuncionario(Funcionário funcionario) {
		Connection conn = null;
		PreparedStatement stmt = null;
		ResultSet rs = null;
